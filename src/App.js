...
const INITIAL_CONTENT = {
  ...
  "ui": {
    ...
    "geographyLabel": "Охват территорий",
    ...
    "cmsTitle": "Панель управления",
    "cmsImport": "Импорт",
    "cmsExport": "Экспорт",
    "cmsPreview": "Просмотр",
    "cmsReset": "Сброс",
    "cmsDiscard": "Сбросить",
    "cmsSave": "Сохранить изменения",
    "cmsSaved": "Сохранено",
    "cmsLogout": "Выход из системы",
    "cmsBuildStatus": "Build Status",
    "cmsActiveSections": "Active Sections",
    "cmsLegalCompliance": "Legal Compliance",
    "cmsSectionManagement": "Управление секциями",
    "cmsSectionHint": "Перетаскивайте и скрывайте блоки лендинга",
    "cmsThemeTitle": "Цветовые схемы",
    "cmsThemeSubtitle": "Настройка внешнего вида темной и светлой темы сайта",
    "cmsBrandTitle": "Логотип и название",
    "cmsLogoHeader": "Масштаб логотипа (Шапка)",
    "cmsLogoFooter": "Масштаб логотипа (Подвал)",
    "cmsRegionBadge": "Метка региона",
    "cmsShowBadge": "Показывать метку",
    "cmsBackToTopLabel": "Кнопка \"Наверх\"",
    "cmsFooterTitle": "Подвал (Footer)",
    "cmsFooterNavHeader": "Заг. Нав",
    "cmsFooterLegalHeader": "Заг. Юр",
    "cmsFooterContactsHeader": "Заг. Конт",
    "cmsAnalyticsTitle": "Интеграции и Аналитика",
    "cmsCookieBannerTitle": "Cookie Баннер",
    "cmsCookieBannerHeader": "Заголовок",
    "cmsCookieBannerBtnAll": "Текст кнопки (Все)",
    "cmsCookieBannerBtnEssential": "Текст кнопки (Осн)",
    "cmsConfirmDiscard": "Вы уверены, что хотите сбросить все несохраненные изменения?",
    "cmsConfirmReset": "ВНИМАНИЕ: Все ваши изменения будут удалены и сайт вернется к исходному состоянию. Продолжить?",
    "cmsImportSuccess": "Контент успешно проверен и загружен! Не забудьте нажать \"Сохранить\", чтобы применить изменения.",
    "cmsValidationError": "Ошибка валидации: файл имеет неверную структуру или содержит небезопасные данные.",
    "cmsParseError": "Ошибка при чтении файла. Убедитесь, что это корректный JSON.",
    "cmsFileTooLarge": "Внимание: файл больше 200 КБ. Рекомендуется использовать оптимизированные изображения.",
    "cmsGroupAppearance": "Внешний вид",
    "cmsGroupContent": "Содержимое",
    "cmsGroupCommunications": "Коммуникации",
    "cmsGroupCompany": "Компания",
    "cmsGroupSystem": "Система",
    "cmsTabTheme": "Оформление",
    "cmsTabBrand": "Бренд",
    "cmsTabStructure": "Структура",
    "cmsTabContent": "Контент",
    "cmsTabContacts": "Контакты",
    "cmsTabRequisites": "Реквизиты",
    "cmsTabLegal": "Юридика",
    "cmsTabSettings": "Настройки",
    "cmsTabAnalytics": "Интеграции",
    "cmsBuildStatus": "Build Status",
    "cmsActiveSections": "Active Sections",
    "cmsLegalCompliance": "Legal Compliance",
    "cmsSectionManagement": "Управление секциями",
    ...
    "cmsThemeSubtitle": "Настройка внешнего вида темной и светлой темы сайта",
    "cmsBrandTitle": "Логотип и название",
    "cmsBrandSubtitle": "Настройка основного брендинга компании",
    "cmsThemeDark": "Темная тема (Dark Mode)",
    "cmsThemeLight": "Светлая тема (Light Mode)",
    "cmsThemeDefault": "Тема по умолчанию",
    "cmsLogoHeader": "Масштаб логотипа (Шапка)",
    "cmsLogoFooter": "Масштаб логотипа (Подвал)",
    "cmsRegionBadge": "Метка региона",
    "cmsShowBadge": "Показывать метку",
    "cmsSocialsTitle": "Соцсети",
    "cmsShowSocials": "Показывать соцсети",
    "cmsAddSocial": "Добавить соцсеть",
    "cmsContentHero": "Hero",
    "cmsContentStats": "Статистика",
    "cmsContentFeatures": "Преимущества",
    "cmsContentServices": "Услуги",
    "cmsContentProcess": "Процесс",
    "cmsContentBPO": "БПО",
    "cmsContentGeography": "Охват",
    "cmsContentClients": "Клиенты",
    "cmsContentNews": "Новости",
    "cmsContentFAQ": "FAQ",
    "cmsAddStat": "Добавить показатель",
    "cmsAddFeature": "Добавить преимущество",
    "cmsAddService": "Добавить услугу",
    "cmsAddStep": "Добавить этап",
    "cmsAddClient": "Добавить клиента"
  },
  "cookieBanner": {
  ...
  "hero": {
    ...
    "title1": "Надёжный партнёр по работе",
    "titleGradient": "с платёжными документами ЖКХ",
    "subtitle": "Печать бесконвертных отправлений, адресная доставка, цифровые сервисы. Полное соответствие 152-ФЗ на всех этапах. Работаем в Воронеже и других регионах.",
  ...
  "bpo": {
    ...
    "ctaText": "Обсудить условия печати",
    "ctaVisible": true,
    "steps": [
      {
        "num": "01",
  ...
  "faq": {
    "title": "Популярные",
    "accent": "вопросы",
    "ctaText": "Остались вопросы — напишите нам",
    "ctaVisible": true,
    "items": [
      {
  ...
  "serviceArea": {
    ...
    "accent": "присутствия",
    "subtitle": "Воронеж и область — собственная курьерская сеть, прямой контроль маршрутов. Для других регионов выстраиваем логистику под задачу клиента — с отчётностью и фиксированными сроками исполнения.",
    ...
    "locations": [
      ...
      {
        "id": 4,
        "name": "Воронежская область (Рамонский р-н)",
        "type": "Полный охват",
        "status": "works",
        "freq": "Ежедневно",
        "isVisible": true
      ...
      {
        "id": 5,
        "name": "Воронежская область (малые населённые пункты)",
        "type": "Частично",
        "status": "inProgress",
        "freq": "По запросу",
        "isVisible": true
