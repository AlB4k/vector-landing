          ...
          <div className="space-y-8">
            <section className={`${isLight ? 'bg-slate-50 border-slate-200' : 'bg-slate-900/30 border-slate-800/50'} p-8 rounded-[2rem] border shadow-xl`}>
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 md:gap-4 pt-2">
                  <div>
                    <p className={`text-[9px] font-black uppercase ${isLight ? 'text-slate-400' : 'text-slate-600'} tracking-widest mb-1`}>ИНН</p>
                    <div className="flex items-center justify-between md:justify-start">
                      <p className={`${isLight ? 'text-slate-900' : 'text-white'} font-bold font-mono text-base md:text-lg`}>{content.inn}</p>
                      <CopyButton text={content.inn} label="inn" />
                    </div>
                  </div>
                  <div>
                    <p className={`text-[9px] font-black uppercase ${isLight ? 'text-slate-400' : 'text-slate-600'} tracking-widest mb-1`}>КПП</p>
                    <div className="flex items-center justify-between md:justify-start">
                      <p className={`${isLight ? 'text-slate-900' : 'text-white'} font-bold font-mono text-base md:text-lg`}>{content.kpp}</p>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 md:gap-4">
                  <div>
                    <p className={`text-[9px] font-black uppercase ${isLight ? 'text-slate-400' : 'text-slate-600'} tracking-widest mb-1`}>ОГРН</p>
                    <div className="flex items-center justify-between md:justify-start">
                      <p className={`${isLight ? 'text-slate-900' : 'text-white'} font-bold font-mono text-base md:text-lg`}>{content.ogrn}</p>
                      <CopyButton text={content.ogrn} label="ogrn" />
                    </div>
                  </div>
                  <div>
                    <p className={`text-[9px] font-black uppercase ${isLight ? 'text-slate-400' : 'text-slate-600'} tracking-widest mb-1`}>ОКВЭД (основной)</p>
                    <p className={`${isLight ? 'text-slate-900' : 'text-white'} font-bold font-mono text-base md:text-lg`}>{content.okved}</p>
                  </div>
                </div>
                <div>
                  <p className={`text-[9px] font-black uppercase ${isLight ? 'text-slate-400' : 'text-slate-600'} tracking-widest mb-1`}>Генеральный директор</p>
                  <p className={`${isLight ? 'text-slate-900' : 'text-white'} font-bold leading-relaxed`}>{content.ceo}</p>
                </div>
              </div>
            </section>
            ...
            <section className={`${isLight ? 'bg-slate-50 border-slate-200' : 'bg-slate-900/30 border-slate-800/50'} p-8 rounded-[2rem] border shadow-xl`}>
              ...
              <div className="space-y-4 text-sm font-medium">
                <div>
                  <p className={`text-[9px] font-black uppercase ${isLight ? 'text-slate-400' : 'text-slate-600'} tracking-widest mb-1`}>Наименование банка</p>
                  <p className={`${isLight ? 'text-slate-900' : 'text-white'} leading-tight font-bold`}>{content.bank.name || 'По запросу'}</p>
                </div>
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <p className={`text-[9px] font-black uppercase ${isLight ? 'text-slate-400' : 'text-slate-600'} tracking-widest mb-1`}>БИК</p>
                    <p className={`${isLight ? 'text-slate-900' : 'text-white'} font-mono font-bold`}>{content.bank.bik || '—'}</p>
                  </div>
                  <div>
                    <p className={`text-[9px] font-black uppercase ${isLight ? 'text-slate-400' : 'text-slate-600'} tracking-widest mb-1`}>Корр. счет</p>
                    <p className={`${isLight ? 'text-slate-900' : 'text-white'} font-mono font-bold`}>{content.bank.ks || '—'}</p>
                  </div>
                </div>
                <div>
                  <p className={`text-[9px] font-black uppercase ${isLight ? 'text-slate-400' : 'text-slate-600'} tracking-widest mb-1`}>Расчетный счет</p>
                  <div className="flex items-center">
                    <p className={`${isLight ? 'text-slate-900' : 'text-white'} font-bold font-mono text-lg`}>{content.bank.rs || '—'}</p>
            ...
            <section className={`${isLight ? 'bg-slate-50 border-slate-200' : 'bg-slate-900/30 border-slate-800/50'} p-8 rounded-[2rem] border shadow-xl`}>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className={`${isLight ? 'text-slate-900' : 'text-white'} font-bold leading-tight`}>Приказ {content.pdnOrder}</p>
                </div>
              </div>
            </section>
          </div>
          ...
          <div className="space-y-8">
            <section className={`${isLight ? 'bg-slate-50 border-slate-200' : 'bg-slate-900/30 border-slate-800/50'} p-8 rounded-[2rem] border shadow-xl h-full`}>
              ...
              <div className="space-y-6 text-sm">
                <div>
                  <p className={`text-[9px] font-black uppercase ${isLight ? 'text-slate-400' : 'text-slate-600'} tracking-widest mb-2`}>Юридический адрес</p>
                  <p className={`${isLight ? 'text-slate-900' : 'text-white'} font-bold leading-relaxed`}>{content.address}</p>
                </div>
                <div className="flex items-center gap-4 pt-4">
                  ...
                  <div>
                    <p className={`text-[8px] font-black uppercase ${isLight ? 'text-slate-400' : 'text-slate-600'} tracking-widest mb-0.5`}>Телефон</p>
                    <a href={`tel:${content.phone}`} className={`${isLight ? 'text-slate-900' : 'text-white'} font-bold hover:text-blue-500 transition-colors`}>{content.phone}</a>
                  </div>
                </div>
                <div className="flex items-center gap-4 pt-2">
                  ...
                  <div>
                    <p className={`text-[8px] font-black uppercase ${isLight ? 'text-slate-400' : 'text-slate-600'} tracking-widest mb-0.5`}>Email</p>
                    <a href={`mailto:${content.email}`} className={`${isLight ? 'text-slate-900' : 'text-white'} font-bold hover:text-blue-500 transition-colors`}>{content.email}</a>
                  </div>
                </div>
